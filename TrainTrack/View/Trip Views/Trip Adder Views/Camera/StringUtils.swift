...
extension String {
	...
	func extractCarriageCode() -> (Range<String.Index>, String)? {
        ...
        for carriage in TrainFetcher.shared.allCarriages {
            
            if let range = self.range(of: carriage, options: [.caseInsensitive, .widthInsensitive], range: nil, locale: nil) {
                
                return (range, carriage)
